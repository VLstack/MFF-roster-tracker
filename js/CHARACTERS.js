...
"black_bolt":       {
                     ...
                     "uniforms":
                     {
                      ...
                      "attilanrising": {"imgValid":true, "name":"Black bolt", "attackBase":"energy", "species":"human", "gender":"male", "side":"hero", "type":"universal", "skills":["Electron channeling", "King's order", "Power word", "Brutal whisper", "Quasi-sonic scream"], "bonus":["Activation rate: when skill (normal attack excluded) is used", "Apply to: Self", "Increase damage by 120% for 1 attack (5 sec.)", "Cooldown time 8 seconds"]}
                     }
                    },
"black_cat":        {
                     "uniform":"modern",
...
"crystal":          {
                     ...
                     "uniforms":
                     {
                      "anad": {"imgValid":true, "name":"Crystal", "attackBase":"energy", "species":"human", "gender":"female", "side":"hero", "type":"blast", "skills":["Cyclone", "Flame manipulation", "Waterspout", "Elemental fusion", "Veil of the Earth"], "bonus":null}
                     }
                    },
"daisy_johnson":    {
                     "uniform":"maos",
...
"gorgon":           {
                     ...
                     "uniforms":
                     {
                      "warofking": {"imgValid":true, "name":"Gorgon", "attackBase":"physical", "species":"human", "gender":"male", "side":"hero", "type":"combat", "skills":["Storming party", "Mace throw", "War cry", "Seismic shocks", "War stomp"], "bonus":null}
                     }
                    },
"hawkeye":          {
                     "uniform":"avengers",
...
"inferno":          {
                     ...
                     "uniforms":
                     {
                      "anad": {"imgValid":true, "name":"Inferno", "attackBase":"energy", "species":"human", "gender":"male", "side":"hero", "type":"blast", "skills":["Burning fist", "Incineration", "Blazing storm", "Ignition", "Volcano burst"], "bonus":null}
                     }
                    },
"iron_fist":        {
                     "uniform":"classic",
...
"karnak":           {
                     ...
                     "uniforms":
                     {
                      "warofking": {"imgValid":true, "name":"Karnak", "attackBase":"physical", "species":"human", "gender":"male", "side":"hero", "type":"speed", "skills":["Side-splitter", "Gale", "Composure", "Charging strike", "Death chop"], "bonus":null}
                     }
                    },
"kingpin":          {
                     "uniform":"modern",
...
"maximus":          {
                     ...
                     "uniforms":
                     {
                      "warofking": {"imgValid":true, "name":"Maximus", "attackBase":"energy", "species":"alien", "gender":"male", "side":"vilain", "type":"blast", "skills":["Deadly invention", "Lunatic control", "Electric barrier", "Ultimate weapon", "Evil trick"], "bonus":null}
                     }
                    },
"medusa":           {
                     "uniform":"anad",
...
"moon_girl":        {
                     ...
                     "uniforms":
                     {
                      "now": {"imgValid":true, "name":"Moon Girl", "attackBase":"physical", "species":"alien", "gender":"female", "side":"hero", "type":"blast", "skills":["Air raid siren", "Taser punch", "Soda bomb", "Moon beam", "Bubble pop"], "bonus":null}
                     }
                    },
"moon_knight":      {
                     "uniform":"modern",
...
"ms_marvel":        {
                     ...
                     "uniforms":
                     {
                      ...
                      "karachi": {"imgValid":true, "name":"Ms marvel - Kamala Khan", "attackBase":"physical", "species":"human", "gender":"female", "side":"hero", "type":"speed", "skills":["Enlarge hook", "Shifting punch", "Morphing stomp", "Party smash", "Polymorph"], "bonus":["Apply to: Self", "Increase all speeds by 10%", "Increase HP by 20%"]}
                     }
                    },
"nebula":           {
                     "uniform":"gg",
