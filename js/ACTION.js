...
MFF.LAYOUT.ACTION =
{
 ...
 "init" : function()
 {
  ...
  new Button({ "renderTo" : container, "label" : "Import / Export", "fa" : "upload", "callback" : MFF.cbImportExport, "styles" : { "float" : "right" } });
  ...
  new Button({ "renderTo" : container, "label" : "Chart", "fa" : "line-chart", "callback" : MFF.renderChart, "className" : "showCharts" });
  new Button({ "renderTo" : container, "label" : "List", "fa" : "bars", "callback" : MFF.renderList, "className" : "showList" });
  new GroupButton({
                   "renderTo" : container, "className" : "sorter",
                   "items" : [
                              { "label" : "Sort by name <i class=\"fa fa-chevron-down\"></i><i class=\"fa fa-chevron-up\"></i>", "callback" : cbSort("sortByName"), "className" : "sortByName" },
                              { "label" : "by percent <i class=\"fa fa-chevron-down\"></i><i class=\"fa fa-chevron-up\"></i>", "callback" : cbSort("sortByPercent"), "className" : "sortByPercent" },
                              { "label" : "by level <i class=\"fa fa-chevron-down\"></i><i class=\"fa fa-chevron-up\"></i>", "callback" : cbSort("sortByLevel"), "className" : "sortByLevel" },
                              { "label" : "by attack <i class=\"fa fa-chevron-down\"></i><i class=\"fa fa-chevron-up\"></i>", "callback" : cbSort("sortByAttack"), "className" : "sortByAttack" }
                             ]
                  });
